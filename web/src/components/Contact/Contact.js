      ...
      <div className="mx-auto max-w-7xl py-16 px-6 sm:py-24 lg:px-8">
        <div className="relative bg-white shadow-xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3">
            {/* Contact information */}
            <div className="relative overflow-hidden bg-gradient-to-br from-[#cd0012] to-[#cd0012]/70  py-10 px-6 sm:px-10 xl:p-12">
              <div
              ...
              <dl className="mt-8 space-y-6">
                ...
                <dd className="flex text-base text-indigo-50">
                  <PhoneIcon
                    ...
                    aria-hidden="true"
                  />
                  <span className="ml-3">+31 0683151916</span>
                </dd>
                <dt>
                ...
                <dd className="flex text-base text-indigo-50">
                  <EnvelopeIcon
                    ...
                    aria-hidden="true"
                  />
                  <span className="ml-3">titus@sprint.nl</span>
                </dd>
              </dl>
